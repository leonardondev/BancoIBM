    ...
    <div id='site_content'>
      <div></div>      
        <div id='tmenubar'>
          <table>
            <tr>
              <td><ul id='menu'><li><a href='paciente1.php'>Por id</a></li></ul></td>
              <td><ul id='menu'><li class='selected'><a href='paciente2.php'>Por nome</a></li></ul></td>
            </tr> 
          </table>
        </div>
      <div class='sidebar'>
...
$cadeia = "SELECT * FROM Paciente ORDER BY nome_paciente;";
